          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="p-8 rounded-2xl bg-[#0F1014] border border-white/5 hover:border-blue-500/30 hover:-translate-y-1 transition-all duration-300 group shadow-lg">
                ...
                <h3 className="text-xl font-bold text-white mb-3">Category Intelligence</h3>
                <p className="text-gray-400 text-sm leading-relaxed">
                  Deep insights across product groups to optimize merchandising and shelf-space allocation.
                </p>
              </div>
